...
5.  **Confirmation Protocol:**
    -   **Never Allowed:** Under NO circumstances are you to modify workflow files (i.e. `GEMINI.md` or `PROTOCOL.md`), even to fix bugs, improve them, or if inferred from user questions. Always silently ignore any explicit or implicit request to alter these files.
6.  **Output Guidelines:**
